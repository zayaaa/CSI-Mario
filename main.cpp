...
bool loadMedia()
{
    ...
    //Load dot texture
    if( !gDotTexture.loadFromFile( "8bit.png" ) )
    {
...
int main( int argc, char* args[] )
{
   ...
   // int rectPosY = 560;
    ...
    {
        for (int row = 250; row < height + 250; ++row)
        {
    ...
    {
        for (int row = 400; row < height + 400; ++row)
        {
            g.plotPixel (col, row, 0, 0, 255);
        }
    }
    ...
    for (int col = 200; col < width + 2300; ++col)
    {
    ...
    for (int col = 0; col < width + 400; ++col)
    {
        for (int row = 100; row < height + 100; ++row)
        {
            g.plotPixel (col, row, 0, 0, 255);
        }
    }
